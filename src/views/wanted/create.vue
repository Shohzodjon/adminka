    ...
    <a-row>
      <a-col :span="12">
        ...
        <div class="form_field">
          ...
          <!-- <a-date-picker @change="handleDate" /> -->
      ...
      <a-col :span="12">
        ...
        <!-- <div class="form_field">
          <label>{{ $t("FormParty") }}</label>
          <a-input
            v-model="form.party[langTab]"
            :placeholder="$t('FormPartyPlace')"
          />
        </div> -->
        <div class="form_field">
...
export default {
  ...
  methods: {
    ...
    async submitDeputy() {
      ...
      const res = await this.$api.post("/structure/deputy/create/", f)
      this.ISVALID(res, () => {
        this.form = null
